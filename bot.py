...
def create_poetry_card(
    ...
    # --------------------------------------------
    # اندازه‌گیری کاملاً در رزولوشن 4x
    # --------------------------------------------
    ...
    for index, line in enumerate(lines):
        ...
        # --------------------------------------------
        # مرکزچینی دقیق بر اساس خود محدوده واقعی حروف
        # --------------------------------------------
        ...
        # --------------------------------------------
        # y به لبه واقعی حروف اشاره می‌کند.
        # bbox_top جبران می‌شود تا خط‌ها دقیق‌تر
        # نسبت به هم قرار بگیرند.
        # --------------------------------------------
    ...
    # sharpening = OFF
    #
    # تا هاله یا پخش‌شدن اطراف حروف ایجاد نشود.
    # --------------------------------------------

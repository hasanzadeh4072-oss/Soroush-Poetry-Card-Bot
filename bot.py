...
def worker(
    ...
    try:
        ...
        print(
            f"[CARD] BUILDING MESSAGE = "
            f"{time.perf_counter() - building_start:.3f}s",
            flush=True
        )
        ...
        print(
            f"[CARD] CREATE CALL TOTAL = "
            f"{time.perf_counter() - create_call_start:.3f}s",
            flush=True
        )
        ...
        print(
            f"[CARD] SEND PHOTO = "
            f"{time.perf_counter() - upload_start:.3f}s",
            flush=True
        )
        ...
        if response is not None and response.ok:
            ...
            print(
                f"[CARD] SUCCESS MESSAGE = "
                f"{time.perf_counter() - success_start:.3f}s",
                flush=True
            )
